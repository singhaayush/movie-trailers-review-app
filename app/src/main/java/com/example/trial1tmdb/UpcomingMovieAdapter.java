...
public class UpcomingMovieAdapter extends RecyclerView.Adapter<UpcomingMovieAdapter.UpcomingMovieViewHolder> {
    ...
    public UpcomingMovieAdapter(Context mContext, ArrayList<MovieEntity> movieList) {
    ...
    public UpcomingMovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UpcomingMovieViewHolder(view,mListener);
    }
    ...
    class UpcomingMovieViewHolder extends RecyclerView.ViewHolder
    {
         ...
         TextView rating;
         TextView movieTitle;
        public UpcomingMovieViewHolder(@NonNull View itemView, final OnItemClickListener listener) {
            super(itemView);
